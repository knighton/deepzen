class BaseDropoutAPI(object):
    ...
    def alpha_dropout0d(self, x, is_training, rate=0.5, axis=None):
        return self.alpha_dropout(x, is_training, rate, axis, 0)

    def alpha_dropout1d(self, x, is_training, rate=0.5, axis=None):
        return self.alpha_dropout(x, is_training, rate, axis, 1)

    def alpha_dropout2d(self, x, is_training, rate=0.5, axis=None):
        return self.alpha_dropout(x, is_training, rate, axis, 2)

    def alpha_dropout3d(self, x, is_training, rate=0.5, axis=None):
        return self.alpha_dropout(x, is_training, rate, axis, 3)
