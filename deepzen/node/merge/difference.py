...
class DifferenceSpec(XXYSpec):
    ...
    def build_xx_y(self, x_sigs=None):
        ...
        y_sig = first_x_sig
        return DifferenceLayer(x_sigs, y_sig)


Difference = keywordize(DifferenceSpec)
